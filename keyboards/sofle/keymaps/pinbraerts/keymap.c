...
[vim] = LAYOUT(
  ...
  KC_BACKS, KC_Z,   KC_X,    KC_C,    KC_V, KC_B,     KC_MUTE,       XXXXXXX,   KC_N,    KC_M, KC_COMM,  KC_DOT,  KC_SLSH,KC_MINUS,
...
[function] = LAYOUT(
  ...
  KC_EQL,  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                           KC_LEFT,     KC_DOWN,    KC_UP,    KC_LEFT, KC_SCLN,  KC_QUOT,
